...
class Main(QWidget):
    ...
    def initui(self):
        ...
        # Создание фона
        label = QLabel(self)
        pixmap = QPixmap('MSDT/msdt-2/8-bit-Tank-Game-master/assets/background.jpg')
        ...
        frist = "MSDT/msdt-2/8-bit-Tank-Game-master/assets/64.png"
        ...
        frist = "MSDT/msdt-2/8-bit-Tank-Game-master/assets/64_d.png"
        pixmap = QPixmap(frist)
    ...
    def create_map(self):
        # Импорт карты из TXT
        with open("MSDT/msdt-2/8-bit-Tank-Game-master/assets/map.txt") as D:
            a = D.read()
            a = a.split("\n")
            for i in a:
                self.map.append(i)
        ...
        for i in range(10):
            for j in range(10):
                if self.map[i][j] == " ":
                    ...
                    frist = "MSDT/msdt-2/8-bit-Tank-Game-master/assets/brick_comp.png"
                    pixmap = QPixmap(frist)
                    ...
                    frist = "MSDT/msdt-2/8-bit-Tank-Game-master/assets/cant_lomatsa.png"
                    pixmap = QPixmap(frist)
                    ...
                    frist = "MSDT/msdt-2/8-bit-Tank-Game-master/assets/listva.png"
                    pixmap = QPixmap(frist)
    ...
    def keyPressEvent(self, event):
        ...
        if event.key() == Qt.Key_Space:
                frist = "MSDT/msdt-2/8-bit-Tank-Game-master/assets/16x16bullet.png"
                pixmap = QPixmap(frist)
    ...
    def timerEvent(self, e):
        ...
        if self.put == 1:
            if self.move == "D":
                frist = "MSDT/msdt-2/8-bit-Tank-Game-master/assets/64_r.png"
                pixmap = QPixmap(frist)
                self.coords2.setPixmap(pixmap)
                a = self.coords2.x()
                ...
                frist = "MSDT/msdt-2/8-bit-Tank-Game-master/assets/64_l.png"
                pixmap = QPixmap(frist)
                self.coords2.setPixmap(pixmap)
                a = self.coords2.x()
                # Выравнивание танка с границей
